...
import {AppHourlyStatsComponent} from './app-hourly-stats/app-hourly-stats.component';
...
const routes: Routes = [
  ...
  {path: 'hourly-stats', component: AppHourlyStatsComponent},
